...
function list_query() {
    ...
    if($app=='인쇄삭제') { 
		$appSql2 = " update mis_parts_storage set print_request_time=null
...
Dy2-me-dd
Th:m:s
W378,52,5,2,M0,8,7,57,0
$url
ATB,35,58,82,82,0,0E,B,0,$g812name
ATB,35,184,82,82,0,0E,B,0,$g1620name
E
