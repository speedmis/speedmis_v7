...
function open_info(p_this) {
	...
	idx = $(p_this).attr('idx');
	url = 'index.php?RealPid=carparts006063&idx='+idx+'&ActionFlag=modify';
...
`;
		...
		if(p_dataItem['autogubun'].length==4) {
...
DELETE from g5_shop_category WHERE ca_id<>'40' AND ca_id LIKE '40%';
...
SELECT fixgubun
,cate_name
,sortG01*999999+sortG02*9999+sortG03*99+sortG04
,ca_skin_dir
,ca_mobile_skin_dir
,ca_skin
,ca_mobile_skin
...
,ca_9
,ca_10
FROM g5_shop_category g5c, mis_parts_cate_b mb
WHERE ca_id='20' AND mb.fixgubun<>'4000' AND mb.fixgubun LIKE '40%';
...
function addLogic_treat() {
	...
	if($question=="move") {
		$sql = " select sortG01,sortG02,sortG03,sortG04,sortG05,depth from mis_parts_cate_b where idx='$p_idx' ";
		$r = allreturnSql($sql);
		$depth = $r[0]['depth'];
		$sortG01 = $r[0]['sortG01'];
		$sortG02 = $r[0]['sortG02'];
		...
		$sql = " 
		update mis_parts_cate_b set sortG01='$sortG01',sortG02='$sortG02',sortG03='$sortG03',sortG04='$sortG04',sortG05='$sortG05' 
		where idx='$p_idx';
		call mis_parts_cate_b_Ordering_Proc();
		";
		//echo $sql;
		execSql($sql);
		echo 'success';
		...
		$sql = " select sortG01,sortG02,sortG03,sortG04,sortG05
		,upidx,depth from mis_parts_cate_b where idx='$p_idx' ";
		$r = allreturnSql($sql);
		...
		$sql = " 
		insert into mis_parts_cate_b (cate_name, upidx, sortG01, sortG02, sortG03, sortG04, sortG05
		, depth, wdater) 
		values (N'$add_name', $upidx, '$sortG01', '$sortG02', '$sortG03', '$sortG04', '$sortG05'
